...
unzip  packages/regression_model/regression_model/datasets/house-prices-advanced-regression-techniques.zip packages/regression_model/regression_model/datasets/
